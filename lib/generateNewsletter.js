 ...
 */
function generateBranchURLs(results, done) {
  ...
  branch.link.createMany(process.env.BRANCH_KEY, branchData).then((data) => {
...
function processData(results) {
  ...
  conference = _.groupBy(_.sortBy(results.conference, 'start_date'), 'category');
